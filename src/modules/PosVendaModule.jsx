      ...
      <Card title="Tipos de mensagem">
        <div className="space-y-3">
          ...
          <Toggle
            ...
            hint="Quando o cliente responde ao lembrete querendo agendar, propoe automaticamente a data prevista. A confirmacao do cliente cai no Inbox para voce fechar o agendamento."
          />
        </div>
      </Card>
